...
recipe_from_id = "SELECT DISTINCT r.recipeId, r.name, r.cuisine, r.calories, r.time, r.instructions, r.image from Recipe as r, {} as query, RecipeRestrictions as R, DietRestrictions as D WHERE r.recipeId = query.recipeId AND query.recipeId = R.recipeId AND D.restrictionId = R.restrictionId"
