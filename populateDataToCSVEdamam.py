...
def run():
    ...
    image, label, cuisineType, calories, ingredientLines = mklist(5)
    # ingrQuantity, ingrMeasure, ingrFood, ingrFood = mklist(4) 
    instructions, healthLabels = mklist(2)
    url = []
    ...
    for result in results:
        ...
        df = pd.DataFrame(data, columns=['Label', 'Image URL', 'Cuisine', 'NumCalories', 'ingredient Lines',  'Recipe URL', 'Preparation instructions', 'health Labels'])
